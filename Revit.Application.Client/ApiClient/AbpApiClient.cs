...
namespace Revit.ApiClient
{
    public class AbpApiClient : ISingletonDependency, IDisposable
    {
        ...
        {
            await DeleteAsync<object>(endpoint, queryParameters, /*accessToken*/null, true);
        }
        ...
        private static async Task<T> ValidateResponse<T>(Task<IFlurlResponse> httpResponse,
            bool stripAjaxResponseWrapper)
        {
