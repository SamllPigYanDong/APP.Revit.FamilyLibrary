...
using Revit.Authorization.Users.Profile;
using Revit.Shared.Services;
using System.Diagnostics;

namespace Revit.Admin.Services.Account
{
    public class UserConfigurationManager
    {
        ...
        //  CommandBase.Instance.Container.Resolve<IApplicationContext>);

        private static IAccessTokenManager AccessTokenManager /*=>
            CommandBase.Instance.Container.Resolve<IAccessTokenManager>()*/;
        ...
        {
            //var userConfigurationService = CommandBase.Instance.Container.Resolve<UserConfigurationService>();
        ...
        private static async Task GetConfigurationSuccessed(AbpUserConfigurationDto result)
        {
            ...
            if (AccessTokenManager.IsUserLoggedIn)
            {
                ...
                stopWatch.Start();
                //var chatService = CommandBase.Instance.Container.Resolve<IChatService>();
                //await chatService.ConnectAsync();
                //stopWatch.Stop();
            }

            //var profileAppService = CommandBase.Instance.Container.Resolve<IProfileAppService>();
        ...
        {
            //var locale = CommandBase.Instance.Container.Resolve<ILocaleCulture>();
