...
namespace Revit.Application.Services.Sessions
{
    /// <summary>
    /// 对话主机服务
    /// </summary>
    public class DialogHostService : DialogService, IHostDialogService
    {
        ...
        public IDialogResult ShowWindow(string name)
        {
            ...
            if (dialogContent is Window view && view.DataContext is null && ViewModelLocator.GetAutoWireViewModel(view)==false)
        ...
        private FrameworkElement GetDialogContent(string name, string IdentifierName = "Root")
        {
            ...
            if (dialogContent is FrameworkElement view && view.DataContext is null && ViewModelLocator.GetAutoWireViewModel(view)==false)
                ViewModelLocator.SetAutoWireViewModel(view, true);
